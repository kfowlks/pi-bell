...
cp -rv ../../../raspbian-addons/home/pi-bell/pi-bell-dist/pi-bell-base/sudo_scripts ../../../pi-bell-base/
chown root:root -Rv ../../../pi-bell-base/sudo_scripts
chmod -v 744 ../../../pi-bell-base/sudo_scripts/*
echo ""
