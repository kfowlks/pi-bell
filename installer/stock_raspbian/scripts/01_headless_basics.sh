...
cp ../../../raspbian-addons/etc/avahi/services/pi-bell.service /etc/avahi/services/
echo ""
...
adduser pi-bell wpaconfig
echo ""

echo "### Updating headless boot scripts."
cp -rv ../../../raspbian-addons/boot/settings/ /boot/
...
# TODO: Replace this with http daemon for pi zero door bell service
...
echo "Device quick reset capability"
insserv pull-reset
update-rc.d pull-reset enable
